...
<body>
    ...
    <div class="position-absolute top-50 start-50 translate-middle w-50 p-3 border">
        ...
        <a href="http://pharmadam.es/compras/php/FacturasTablas.php" class="btn btn-outline-secondary">Volver</a>
    </div>
    ...
    <script>
        ...
        function aviso() {
            ...
            if (acepta) {
                window.location.href = "borrarFactura.php?valor=" + encodeURIComponent('<?php echo $valor; ?>');
            } 
        } 
    </script>
</body>
