...
<body>
    <div class="position-absolute top-50 start-50 translate-middle w-50 p-3 border">
        ...
        <a href="http://pharmadam.es/compras/php/HistorialComprasTabla.php" class="btn btn-outline-secondary">Volver</a>
    </div>

    <script>

        //programa js que realiza una ultima confirmación con alert 
        ...
        function aviso() {
            ...
            if (acepta) {
                window.location.href = "borrarCompra.php?valor=" + encodeURIComponent('<?php echo $valor; ?>');
            } 
