...
<html lang="es">
  ...
  <body class="app sidebar-mini">
    ...
    <script src="<?php echo media(); ?>/Admin/js/jquery-3.3.1.min.js"></script>
    <script src="<?php echo media(); ?>/Admin/js/popper.min.js"></script>
    <script src="<?php echo media(); ?>/Admin/js/bootstrap.min.js"></script>
    <script src="<?php echo media(); ?>/Admin/js/main.js"></script>
    <!-- The javascript plugin to display page loading on top-->
    <script src="<?php echo media(); ?>/Admin/js/plugins/pace.min.js"></script>
